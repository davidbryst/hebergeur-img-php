<div class="w-2/3 m-auto h-3/4 bg-one rounded flex shadow-xl">
    <div class="relative bg-ten text-one w-1/2 flex rounded-l-xl">
        <p class="w-3/4 text-2xl m-auto"><span class="text-5xl mb-12">Hello!</span> <br> Signup to get started</p>
        <p class="w-3/4 absolute top-[90%] left-1/2 -translate-x-1/2 text-sm">i already have acount</p>
    </div>
